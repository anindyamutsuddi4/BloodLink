        ...
        <div className='pt-17'>
            <div className="drawer lg:drawer-open">
                ...
                <div className="drawer-side is-drawer-close:overflow-visible">
                    ...
                    <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-21 is-drawer-open:w-64 hover:is-drawer-open:w-64">
                        ...
                        <ul className="menu w-full grow">
                            ...
                            {//role =admin hoilei ei component gula dekhabe
                                ...
                                <>
                                    <li>
                                        <NavLink to='/dashboard/approveriders' className="is-drawer-close:tooltip is-drawer-close:tooltip-right"
                                    ...
                                    <li>
                                        <NavLink to='/dashboard/manageusers' className="is-drawer-close:tooltip is-drawer-close:tooltip-right"
                                    ...
                                    <li>
                                        <NavLink to='/dashboard/assignriders' className="is-drawer-close:tooltip is-drawer-close:tooltip-right"
